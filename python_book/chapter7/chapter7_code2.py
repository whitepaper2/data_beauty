...
# part4
# lables:['日均UV' '平均注册率' '平均搜索量' '访问深度' '平均停留时间' '订单转化率']
ax.set_thetagrids(angles * 180 / np.pi, np.array(["daily avg UV", "avg register rate", "avg search", "scan depth", "avg stay time", "order conversion rate"]), fontproperties="SimHei")  # 设置极坐标轴
# ax.set_thetagrids(angles * 180 / np.pi, labels, fontproperties="SimHei")  # 设置极坐标轴
ax.set_title("Comparison of significant feature of cluster", fontproperties="SimHei")  # 设置标题放置
